...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        for(int i = 0; i < 1000; i++)
        {
            ...
            Trainer trainer = new Trainer(2, 1, 2, new int[]{100, 100, 10, 10, 2}, new double[][]{{2, 3}, {4, 5}, {4, 2}}, new double[][]{{6}, {20}, {8}});
            trainer.setSeed(i);
            trainer.teachMult(2, start);
        ...
        for(int i = 0; i < niceTimes; i++)
        {
            long start = System.currentTimeMillis();
            Trainer trainer = new Trainer(2, 1, 2, new int[]{100, 100, 10, 10, 2}, new double[][]{{2, 3}, {4, 5}, {4, 2}}, new double[][]{{6}, {20}, {8}});
            trainer.setSeed(niceSeed[i]);
            trainer.teachMult(3, start);
        ...
        for(int i = 0; i < greatTimes; i++)
        {
            long start = System.currentTimeMillis();
            Trainer trainer = new Trainer(2, 1, 2, new int[]{100, 100, 10, 10, 2}, new double[][]{{2, 3}, {4, 5}, {4, 2}}, new double[][]{{6}, {20}, {8}});
            trainer.setSeed(greatSeed[i]);
            trainer.teachMult(4, start);
        ...
        for(int i = 0; i < excellentTimes; i++)
        {
            long start = System.currentTimeMillis();
            Trainer trainer = new Trainer(2, 1, 2, new int[]{100, 100, 10, 10, 2}, new double[][]{{2, 3}, {4, 5}, {4, 2}}, new double[][]{{6}, {20}, {8}});
            trainer.setSeed(excellentSeed[i]);
            trainer.teachMult(5, start);
